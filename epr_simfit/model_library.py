...
def comprehensive_spin_trap_adducts() -> dict[str, SpinComponent]:
    ...
    D = [
        ...
        # ── Methanol decomposition/oxidation radicals (•CH2OH → •CHO → CO2; •OCH3) ──
        ("dmpo_hydroxymethyl", "DMPO-CH2OH (•CH2OH, methanol)", "DMPO", "hydroxymethyl", 2.0057, [("14N", 15.8), ("1H", 22.8)], 0.10,
         "spin trap / methanol", "Methanol-derived hydroxymethyl radical trapped by DMPO (aN≈15.8, aβH≈22.8 G).", ""),
        ("pbn_hydroxymethyl", "PBN-CH2OH (•CH2OH, methanol)", "PBN", "hydroxymethyl", 2.0057, [("14N", 15.5), ("1H", 3.6)], 0.10,
         "spin trap / methanol", "Methanol-derived hydroxymethyl radical trapped by PBN.", ""),
        ("dmpo_methoxyl", "DMPO-OCH3 (methoxyl)", "DMPO", "methoxyl", 2.0057, [("14N", 14.7), ("1H", 7.6)], 0.11,
         "spin trap / methanol", "Methanol-derived methoxyl (RO•) radical trapped by DMPO (alkoxyl-type).", ""),
        ("dmpo_formyl", "DMPO-CHO (•CHO formyl/acyl)", "DMPO", "acyl", 2.0057, [("14N", 15.6), ("1H", 19.0)], 0.11,
         "spin trap / methanol", "Formyl/acyl radical (methanol over-oxidation toward CO2) trapped by DMPO.", ""),
        ("pbn_formyl", "PBN-CHO (•CHO formyl/acyl)", "PBN", "acyl", 2.0057, [("14N", 15.6), ("1H", 3.8)], 0.10,
         "spin trap / methanol", "Formyl/acyl radical trapped by PBN.", ""),
        # ── DMSO decomposition radicals (in DMPO; PBN/DMSO set is above) ──
        ("dmpo_dmso_methyl", "DMPO-CH3 (•CH3 from DMSO)", "DMPO/DMSO", "methyl", 2.0057, [("14N", 16.4), ("1H", 23.4)], 0.10,
         "spin trap / DMSO", "DMSO-derived methyl radical trapped by DMPO; mandatory DMPO/DMSO control.",
         "Solvent-derived: run a DMPO/DMSO blank before assigning reaction radicals."),
        ("dmpo_dmso_sulfinylmethyl", "DMPO-CH2S(O)CH3 (methanesulfinylmethyl)", "DMPO/DMSO", "sulfinylmethyl", 2.0057, [("14N", 14.8), ("1H", 20.9)], 0.11,
         "spin trap / DMSO", "DMSO-derived •CH2S(O)CH3 radical trapped by DMPO.", ""),
        # ── H2O2 / water-splitting radicals (•OH, •OOH/O2•-, •H; H2O2 itself is EPR-silent) ──
        ("dmpo_h2o2_oh", "DMPO-OH (•OH from H2O2 / water oxidation)", "DMPO", "hydroxyl", 2.0056, [("14N", 14.9), ("1H", 14.9)], 0.09,
         "spin trap / H2O2", "Hydroxyl radical (H2O2 homolysis, Fenton, or water oxidation) — classic 1:2:2:1 quartet.",
         "•OH can also arise from O2•- or DMPO-OOH decay; confirm with SOD/catalase and DMSO competition."),
        ("dmpo_h_water_split", "DMPO-H (•H atom, HER / water reduction)", "DMPO", "H atom", 2.0057, [("14N", 16.6), ("1H", 22.5), ("1H", 22.5)], 0.10,
         "spin trap / H2O2", "Hydrogen-atom adduct — reductive (HER / water-splitting) side.", ""),
        # ── NH3 decomposition radicals (N-centred: •NH2 aminyl, •NH) ──
        ("dmpo_aminyl_nh2", "DMPO-NH2 (•NH2 aminyl, NH3 decomp.)", "DMPO", "aminyl", 2.0056, [("14N", 15.3), ("1H", 19.9), ("14N", 1.5)], 0.11,
         "spin trap / NH3", "Candidate aminyl (•NH2) adduct from NH3 decomposition; second small 14N from the trapped amino group.",
         "N-centred candidate: confirm with 15N-NH3 labelling and NH3/blank controls before assignment."),
        ("pbn_aminyl_nh2_nh3", "PBN-NH2 (•NH2 aminyl, NH3 decomp.)", "PBN", "aminyl", 2.0055, [("14N", 14.8), ("1H", 2.6), ("14N", 1.5)], 0.10,
         "spin trap / NH3", "Candidate aminyl (•NH2) adduct from NH3 decomposition trapped by PBN.",
         "N-centred candidate: requires 15N-NH3 confirmation and controls."),
        ("dmpo_imino_nh", "DMPO-NH (•NH imino/aminyl)", "DMPO", "imino", 2.0056, [("14N", 15.0), ("1H", 17.5), ("14N", 1.2)], 0.12,
         "spin trap / NH3", "Candidate imino/aminyl (•NH) adduct from deeper NH3 dehydrogenation.",
         "N-centred candidate: highly tentative — requires 15N labelling and independent confirmation."),
    ]
...
MODEL_PRESETS: dict[str, list[str]] = {
    ...
    # ── Reaction-specific decomposition / mechanism presets ──
    "MEOH_methanol_decomposition": ["dmpo_hydroxymethyl", "pbn_hydroxymethyl", "dmpo_methoxyl",
                                    "dmpo_formyl", "pbn_formyl", "dmpo_oh", "pbn_oh"],
    "DMSO_solvent_decomposition": ["pbn_dmso_methyl", "dmpo_dmso_methyl", "pbn_dmso_sulfinylmethyl",
                                   "dmpo_dmso_sulfinylmethyl", "pbn_dmso_methylsulfinyl"],
    "H2O2_water_splitting": ["dmpo_h2o2_oh", "dmpo_ooh", "dmpo_h_water_split", "pbn_oh",
                             "pbn_ooh_o2minus", "pbn_h_atom_adduct"],
    "NH3_decomposition": ["dmpo_aminyl_nh2", "pbn_aminyl_nh2_nh3", "dmpo_imino_nh",
                          "pbn_nh2_candidate", "pbn_nnh_candidate", "pbn_oh"],
...
MODEL_DESCRIPTIONS: dict[str, str] = {
    ...
    "MEOH_methanol_decomposition": "Methanol decomposition/oxidation radicals (hydroxymethyl •CH2OH, methoxyl, formyl) in DMPO and PBN, with •OH.",
    "DMSO_solvent_decomposition": "DMSO solvent-decomposition radicals (methyl, sulfinylmethyl, methylsulfinyl) in PBN and DMPO — mandatory solvent controls.",
    "H2O2_water_splitting": "H2O2 / water-splitting radicals: •OH quartet, superoxide/hydroperoxyl, and •H atom (HER) across DMPO and PBN.",
    "NH3_decomposition": "NH3-decomposition N-centred candidates (aminyl •NH2, imino •NH) in DMPO and PBN — require 15N-NH3 confirmation.",
