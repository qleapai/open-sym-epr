...
def absorption_kernel(
    ...
    The kernel half-width is capped so the kernel is never longer than the field
    axis; otherwise a large linewidth over a narrow field window would make
    numpy.convolve(..., mode="same") return a longer array.
    """
